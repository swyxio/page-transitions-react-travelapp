          ...
          const page =
            {
              ...
              '/place': 'place',
              '/group': 'group'
            }[this.props.location.pathname] || 'index'; // dont really ever need this fallback but just in case
            ...
            <header className={page}>
              ...
              <div className="nav-wrapper">
                <nav>
                  <ul>
                    <li>
                      <NavLink activeClassName="nuxt-link-active" exact to="/">
                        {firstName}'s Home
                      </NavLink>
                    </li>
                    <li>
                      <NavLink activeClassName="nuxt-link-active" to="/place">
                        {firstName}'s Places
                      </NavLink>
                    </li>
                    <li>
                      <NavLink activeClassName="nuxt-link-active" to="/group">
